...
label_english = str(pathlib.Path().absolute()) + '/src/qr-ets-app/.labels_en.txt'
...
# Variabeln
config_path = tk.StringVar(value=label_german)
...
# Labels  für Empfänger erstellen.
...
lab_abs_list = [get_data('lab_abs'), '', '', get_data('lab_plz'),
                get_data('lab_ort'), get_data('lab_cur'), get_data('lan_ger')]
